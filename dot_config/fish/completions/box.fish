...
complete -c box -n '__fish_box_needs_command' -a init -d 'Initialize box, install packages, seed dotfiles'
...
complete -c box -n '__fish_box_needs_command' -a clean -d 'Remove orphan container for this directory'
complete -c box -n '__fish_box_needs_command' -a doctor -d 'Check box dependencies and state'
